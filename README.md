...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kcoreaddons-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8470&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kcoreaddons-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8470&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kcoreaddons-feedstock?branchName=main&jobName=linux&configuration=linux_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `kcoreaddons` can be installed with `conda`:
...
```
mamba install kcoreaddons
```

It is possible to list all of the versions of `kcoreaddons` available on your platform with `conda`:
...
```
mamba search kcoreaddons --channel conda-forge
```
...
mamba repoquery search kcoreaddons --channel conda-forge

# List packages depending on `kcoreaddons`:
mamba repoquery whoneeds kcoreaddons --channel conda-forge

# List dependencies of `kcoreaddons`:
mamba repoquery depends kcoreaddons --channel conda-forge
```
